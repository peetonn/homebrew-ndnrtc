...
class Ndnrtc < Formula
    ...
    resource "openfec" do
      url "http://131.179.142.37:8000/openfec-active-macos.tar.gz"
      sha256 "238db7a08f30cc1ee6a17418f625894bd4bb8adcdda6e3657e9acb3190ddc02a"
    end
  
    resource "ndn-cpp" do
      url "http://131.179.142.37:8000/ndn-cpp-active-macos.tar.gz"
      sha256 "2b66fa2e4bc96c79081576d2c64ad474fb90728e59bf69820f5c724b44932697"
    end
  
    resource "webrtc" do
      url "http://131.179.142.37:8000/webrtc-active-macOS.tar.gz"
